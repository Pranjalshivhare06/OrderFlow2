...
//   const generateQRCodeImage = (tableNumber) => {
//   const baseUrl = 'dapper-muffin-326944.netlify.app'; // Your actual Netlify URL
//   const url = `${baseUrl}/order/${tableNumber}`;
//   return `https://api.sqrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(url)}`;
// };
